...
func Markdown(log *logrus.Logger, changeLogFilePath, commitHistory string, releases []*helm.Release) {
	...
	f.WriteString("Autogenerated from Helm Chart and git history using [helm-changelog](https://github.com/tropnikovvl/helm-changelog)\n")
}
